    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "development-bg": "hsl(var(--status-development-bg))",
          mastered: "hsl(var(--status-mastered))",
          "mastered-bg": "hsl(var(--status-mastered-bg))",
          expert: "hsl(var(--status-expert))",
          "expert-bg": "hsl(var(--status-expert-bg))",
        },
        grid: {
          header: "hsl(var(--grid-header))",
          "cell-selected": "hsl(var(--grid-cell-selected))",
